...
// 검색결과 목록 또는 마커 위에 포인터가 있을 때 호출되는 함수입니다
// 인포윈도우에 장소명을 표시합니다
...
// --------------------------------------------------------------------
/*
function finalCount() { // 인원수만큼 창 띄우기
    ...
    // console.log(typeof people); -> 문자열이니까 숫자로 변환
    people = parseInt(people);
  

    
    // 브라우저에 결과를 출력할 element 가져오기
    const dispalyElement = document.getElementById('display');

    // 현재 화면에 출력되어 있는 값 가져오기
    let number = displayElement.innerText;
